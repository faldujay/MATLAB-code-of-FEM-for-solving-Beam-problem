...
coord = [1,   0.0;           % First Column is Node numbers
         2,   L1*0.5;
         3,   L1;            % Second Column is Co-ordinate
         4,   L1+L2*0.5;
         5,   L1+L2;
         6,   L1+L2+L3*0.5;
         7,   L1+L2+L3];
...
q_load = [1, q0,            -(q0-((q0-q2)/2))/(0.5*L1),  0;  % First Column is element number
          2, (q0-q2)/2,     -(((q0-q2)/2) - q2)/(0.5*L1), 0;
          3, q2,                      0,  0;
          4, q2,                      0,  0];  % For quadratic load  q = a + bx + cx^2                       
